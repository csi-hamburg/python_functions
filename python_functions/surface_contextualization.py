...
# %% auto 0
__all__ = ['plot_surface', 'surface_to_schaefer', 'perform_spins', 'plot_null_distributions', 'plot_scatter']
...
def plot_scatter(
    ...
    measure_name1, # name of the measure to plot on the x-axis
    array2, # array with values to plot on the y-axis
    measure_name2, # name of the measure to plot on the y-axis
    r, # spearman correlation between both arrays
    p, # p-value between both arrays
    cmap=None, # color map to use
    loc_annot="upper right" # location of the annotation
    ):
    ...
    at = AnchoredText(
    f'$r_{{sp}}$={r:.2f} \n$p_{{spin}}$={p:.3f}', prop=dict(size=11), frameon=False, loc=loc_annot)
    axs.add_artist(at)
